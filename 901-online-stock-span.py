...
# Note: Calls to StockSpanner.next(int price) will have 1 <= price <=
# 10^5.
#   * There will be at most 10000 calls to StockSpanner.next per test
#     case.
#   * There will be at most 150000 calls to StockSpanner.next across all
#     test cases.
#   * The total time limit for this problem has been reduced by 75% for
#     C++, and 50% for all other languages.
