...
# like: "Hi, A. Do you know B?" to get information about whether A knows
...
# whether A knows B. Implement a function int findCelebrity(n). There
# will be exactly one celebrity if he/she is in the party. Return the
...
# graph[i][j] = 1 means person i knows person j, otherwise graph[i][j] =
# 0 means person i does not know person j. The celebrity is the person
...
# 3 * n, could you find a solution without exceeding the maximum number
# of calls?
