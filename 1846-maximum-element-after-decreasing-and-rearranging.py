...
# Input: arr = [1,2,3,4,5]
# Output: 5
# Explanation: The array already satisfies the conditions, and the
...
s = Solution()
checkValue(2, s.maximumElementAfterDecrementingAndRearranging([1, 1, 1, 1, 1, 100]))
checkValue(6, s.maximumElementAfterDecrementingAndRearranging([5, 5, 5, 5, 5, 100]))
checkValue(6, s.maximumElementAfterDecrementingAndRearranging([1, 2, 5, 6, 100, 100]))
checkValue(3, s.maximumElementAfterDecrementingAndRearranging([1, 1, 2, 2, 3, 3]))
checkValue(3, s.maximumElementAfterDecrementingAndRearranging([1, 2, 2, 3, 3, 3]))
checkValue(3, s.maximumElementAfterDecrementingAndRearranging([9, 73, 98]))
checkValue(2, s.maximumElementAfterDecrementingAndRearranging([1, 1, 100]))
checkValue(3, s.maximumElementAfterDecrementingAndRearranging([2, 73, 98]))
