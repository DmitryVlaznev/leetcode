...
# Use the two stack operations to make the numbers in the stack (from
# the bottom to the top) equal to target. You should follow the
# following rules:
...
s = Solution()
checkList(["Push", "Push", "Pop", "Push"], s.buildArray([1, 3], 3))
checkList(["Push", "Pop", "Push", "Push", "Push"], s.buildArray([2, 3, 4], 4))
