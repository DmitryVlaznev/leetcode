...
# children that have not been selected till now decreases by 1. Note
# that the happiness value cannot become negative and gets decremented
...
#   the remaining child becomes [0]. Note that the happiness value
