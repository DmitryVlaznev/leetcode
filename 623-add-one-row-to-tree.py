...
# N's left subtree root and right subtree root. And N's original left
# subtree should be the left subtree of the new left subtree root, its
# original right subtree should be the right subtree of the new right
# subtree root. If depth d is 1 that means there is no depth d-1 at all,
...
t.addOneRow(treeFromArray([4, 2, 6, 3, 1, 5], 0), 42, 4)
