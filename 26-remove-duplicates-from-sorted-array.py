...
checkValue(2, s.removeDuplicates([1, 1, 2]))
checkValue(5, s.removeDuplicates([0, 0, 1, 1, 1, 2, 2, 3, 3, 4]))
checkValue(4, s.removeDuplicates([0, 1, 2, 3]))
checkValue(1, s.removeDuplicates([0, 0]))
