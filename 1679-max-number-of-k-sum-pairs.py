...
checkValue(2, t.maxOperations([1, 2, 3, 4], 5))
checkValue(2, t.maxOperations([2, 2, 2, 4, 4], 6))
checkValue(1, t.maxOperations([3, 1, 3, 4, 3], 6))
checkValue(0, t.maxOperations([3, 1, 6, 4, 1], 6))
