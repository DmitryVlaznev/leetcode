...
checkValue(49, t.maxArea([1, 8, 6, 2, 5, 4, 8, 3, 7]))
checkValue(1, t.maxArea([1, 1]))
checkValue(1, t.maxArea([1, 3]))
checkValue(16, t.maxArea([4, 3, 2, 1, 4]))
checkValue(2, t.maxArea([1, 2, 1]))
checkValue(24, t.maxArea([1, 3, 2, 5, 25, 24, 5]))
