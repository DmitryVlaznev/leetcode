// 5372. Minimum Value to Get Positive Step by Step Sum
...
console.log("5 = ", minStartValue([-3,2,-3,4,2]));
console.log("1 = ", minStartValue([]));
console.log("1 = ", minStartValue([0, 0]));
console.log("1 = ", minStartValue([1, 2]));
console.log("2 = ", minStartValue([1, -2, 8]));
