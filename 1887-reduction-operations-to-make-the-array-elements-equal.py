...
s = Solution()
checkValue(3, s.reductionOperations([5, 1, 3]))
checkValue(0, s.reductionOperations([1, 1, 1]))
checkValue(4, s.reductionOperations([1, 1, 2, 2, 3]))
checkValue(3, s.reductionOperations([2, 2, 2, 1]))
