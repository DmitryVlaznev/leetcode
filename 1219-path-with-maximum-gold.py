...
# Never visit a cell with 0 gold. You can start and stop collecting gold
# from any position in the grid that has some gold.
    ...
    def getMaximumGold(self, grid: List[List[int]]) -> int:
        def walk(r, c, grid, visited):
            ...
            for dr, dc in d:
                ...
                res = max(res, grid[r][c] + walk(r + dr, c + dc, grid, visited))
            visited.remove((r, c))
            return res
