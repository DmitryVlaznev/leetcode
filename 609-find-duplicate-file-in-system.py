...
# content. A file path is a string that has the following format:
...
# directory. A single blank space separates the directory path and file
# info.
...
class Solution:
    def findDuplicate(self, paths: List[str]) -> List[List[str]]:
        ...
        for dir in paths:
            ...
            for file in ls[1:]:
                bi = file.index("(")
                contents[file[bi + 1 : -1]].append(dirpath + "/" + file[0:bi])
        res = []
