...
# If the integer is out of the 32-bit signed integer range [-2^31, 2^31 -
...
# Since -91283472332 is less than the lower bound of the range [-2^31,
# 2^31 - 1], the final result is clamped to -2^31 = -2147483648.
...
class Solution:
    def myAtoi(self, s: str) -> int:
        sign, digits, p = 1, [], 0
        signProcessed = whiteSpaceProcessed = False
...
checkValue(42, t.myAtoi("42"))
checkValue(42, t.myAtoi("   42"))
checkValue(42, t.myAtoi("   +42"))
checkValue(42, t.myAtoi("42sddsf12"))
checkValue(42, t.myAtoi(" 42+dsds32"))
checkValue(-42, t.myAtoi("-42"))
checkValue(-42, t.myAtoi("  -42"))
checkValue(-42, t.myAtoi("  -42 32"))
checkValue(0, t.myAtoi("werwer  -42 32"))
checkValue(0, t.myAtoi(""))
checkValue(42, t.myAtoi("0042"))
checkValue(-42, t.myAtoi("-0042"))
checkValue(0, t.myAtoi("  +  413"))
checkValue(2147483647, t.myAtoi("   912834723321321sdfsd"))
checkValue(-2147483648, t.myAtoi("-91283472332"))