...
# travels in the sequence 1 -> 5 -> 7 -> 1 -> 5 -> 7 -> 1 -> ...
# forever.
...
# Output: 2
# Explanation: The best strategy is take the first bus to the bus stop
# 7, then take the second bus to the bus stop 6.
