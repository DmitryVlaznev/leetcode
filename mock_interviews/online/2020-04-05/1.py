...
#              win the game; No matter 1, 2, or 3 stones you remove, the
...
t = Solution()
print("False", t.canWinNim(4))
print("False", t.canWinNim(8))
print("True", t.canWinNim(5))
print("True", t.canWinNim(10))